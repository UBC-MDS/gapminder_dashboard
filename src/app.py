...
opt_dropdown_years = [{'label': year, 'value': year}
                                            for year in np.unique(gap['year'].dt.year)]
...
opt_dropdown_target_y = [{'label': 'Population', 'value': 'population'},
...
# TBD - Other options to be added 
opt_dropdown_target_x = [{'label': 'Population', 'value': 'population'},
                        {'label': 'Income Group', 'value': 'income_group'},
                        {'label': 'GDP', 'value': 'income'},
                        {'label': 'Life Expectancy', 'value': 'life_expectancy'},
                        {'label': 'Children per woman', 'value': 'children_per_woman'},
...
opt_dropdown_country = [{'label': country, 'value': country}
            ...
            [
                ...
                dbc.Col(
                    [
                        ...
                        dcc.Dropdown(id = 'target_input_y', 
                                    value = 'life_expectancy',
                                    options=opt_dropdown_target_y,
                                    className='dropdown'
                                    ),
                        html.Br(),
                        dcc.Dropdown(id = 'target_input_x', 
                                    value = 'income',
...
def plot_lifeexp_gdp(year, region, target_y, target_x):
    ...
    if region == 'All':
        ...
        idx = np.where((gap['year'].dt.year == year) & (gap['region'] == region))
