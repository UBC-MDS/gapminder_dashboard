...
filter_panel = [
    ...
    html.H4("Interpretation of Target of Study:", style = {'margin-bottom':'7px'}),
    html.H6("- Population is number of people living", style = {'margin':'0px'}),
    html.H6("- Income is GDP per capita adjusted for purchasing power", style = {'margin':'0px'}),
    html.H6("- Children per Woman is the number of children born to each woman", style = {'margin':'0px'}),
    html.H6("- Child Mortality is deaths of children under 5 per 1000 live births", style = {'margin':'0px'}),
    html.H6("- Population Density is average number of people per km2", style = {'margin':'0px'}),
    html.H4("Region", style = {'margin-bottom':'7px'}),
    dcc.RadioItems(
        id="region_input",
        value="Africa",
    ...
    # html.Br(),
    html.H4("Country", style = {'margin-bottom':'7px'}),
    dcc.Dropdown(
        id="country_input",
        value="Angola",
        className="dropdown",
    ...
    # html.Br(),
    html.H4("Year", style = {'margin-bottom':'7px'}),
    dcc.Slider(
        id="year_input",
        min=1950,
        max=2018,
